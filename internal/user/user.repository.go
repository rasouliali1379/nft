...
func (u UserRepository) Exists(c context.Context, conditions persist.D) (bool, error) {
...
func (u UserRepository) Get(c context.Context, conditions persist.D) (usermodel.User, error) {
